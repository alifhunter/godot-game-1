...
const CHART_BACKGROUND := Color(0.0431373, 0.0745098, 0.113725, 0.99)
const CHART_BORDER := Color(0.164706, 0.219608, 0.317647, 0.95)
const GRID_COLOR := Color(0.105882, 0.145098, 0.207843, 0.62)
const BASELINE_COLOR := Color(0.113725, 0.631373, 0.94902, 0.46)
const AXIS_TEXT_COLOR := Color(0.545098, 0.611765, 0.701961, 0.96)
const AXIS_LINE_COLOR := Color(0.164706, 0.219608, 0.317647, 0.9)
const CANDLE_UP_COLOR := Color(0.0901961, 0.768627, 0.419608, 0.98)
const CANDLE_DOWN_COLOR := Color(0.94902, 0.235294, 0.352941, 0.98)
const CROSSHAIR_COLOR := Color(0.113725, 0.631373, 0.94902, 0.42)
const HOVER_PANEL_FILL := Color(0.0745098, 0.113725, 0.168627, 0.96)
const HOVER_PANEL_BORDER := Color(0.239216, 0.317647, 0.439216, 0.95)
const HOVER_PANEL_TEXT := Color(0.901961, 0.929412, 0.968627, 1)
const DRAWING_LINE_COLOR := Color(0.941176, 0.717647, 0.239216, 0.94)
const DRAWING_SELECTED_COLOR := Color(0.113725, 0.631373, 0.94902, 1)
const DRAWING_PREVIEW_COLOR := Color(0.941176, 0.717647, 0.239216, 0.56)
const PATTERN_REGION_COLOR := Color(0.113725, 0.631373, 0.94902, 0.92)
const PATTERN_REGION_FILL := Color(0.113725, 0.631373, 0.94902, 0.13)
const PATTERN_REGION_PENDING := Color(0.113725, 0.631373, 0.94902, 0.52)
